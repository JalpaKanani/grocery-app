...
class SeeAll1Widget extends StatefulWidget {
  final Data? data1;
  final SettingData? settingData;

  SeeAll1Widget(ProductElement data,  {  this.settingData, this.data1});

  @override
  _SeeAll1WidgetState createState() => _SeeAll1WidgetState();
}

class _SeeAll1WidgetState extends State<SeeAll1Widget> {
  late bool isLoading;
  ...
  Widget build(BuildContext context) {
    return Scaffold(   appBar: AppBar(
      title: Text( widget.data1!.categoryWithProduct![1].title.toString()),
      leading: IconButton(
  ...
  Widget _buildBody() {
    return isLoading
      ...
      child: ListView.builder(
        itemCount: widget.data1!.categoryWithProduct![1].products!.length,
        itemBuilder: (context, index) {
          final data =
          widget.data1!.categoryWithProduct![1].products![index];
          return Card(
            elevation: 5,
                        ...
                        child: Image(
                          image: NetworkImage(
                              "http://gng.invatomarket.com/public/storage/" +
                                  widget.data1!.categoryWithProduct![1]
