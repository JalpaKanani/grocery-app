...
class SeeAll2Widget extends StatefulWidget {
  final Data? data1;
  final SettingData? settingData;

  SeeAll2Widget(ProductElement data,  {  this.settingData, this.data1});

  @override
  _SeeAll2WidgetState createState() => _SeeAll2WidgetState();
}

class _SeeAll2WidgetState extends State<SeeAll2Widget> {
  late bool isLoading;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text( widget.data1!.categoryWithProduct![2].title.toString()),
        leading: IconButton(
  ...
  Widget _buildBody() {
    return isLoading
      ...
      child: ListView.builder(
        itemCount: widget.data1!.categoryWithProduct![2].products!.length,
        itemBuilder: (context, index) {
          final data =
          widget.data1!.categoryWithProduct![2].products![index];
          return Card(
            elevation: 5,
                        ...
                        child: Image(
                          image: NetworkImage(
                              "http://gng.invatomarket.com/public/storage/" +
                                  widget.data1!.categoryWithProduct![2]
