...
class SeeAll3Widget extends StatefulWidget {
  final Data? data1;
  final SettingData? settingData;

  SeeAll3Widget(ProductElement data,  {  this.settingData, this.data1});

  @override
  _SeeAll3WidgetState createState() => _SeeAll3WidgetState();
}

class _SeeAll3WidgetState extends State<SeeAll3Widget> {
  late bool isLoading;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text( widget.data1!.categoryWithProduct![3].title.toString()),
        leading: IconButton(
  ...
  Widget _buildBody() {
    return isLoading
      ...
      child: ListView.builder(
        itemCount: widget.data1!.categoryWithProduct![3].products!.length,
        itemBuilder: (context, index) {
          final data =
          widget.data1!.categoryWithProduct![3].products![index];
          return Card(
            elevation: 5,
                        ...
                        child: Image(
                          image: NetworkImage(
                              "http://gng.invatomarket.com/public/storage/" +
                                  widget.data1!.categoryWithProduct![3]
