...
class SeeAllWidget extends StatefulWidget {
  ...
  SeeAllWidget(ProductElement data, {this.settingData, this.data1});
...
class _SeeAllWidgetState extends State<SeeAllWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.data1!.categoryWithProduct![0].title.toString()),
        leading: IconButton(
    ...
    return isLoading
      ...
      padding: const EdgeInsets.only(top: 10, left: 8, right: 8),
          child: ListView.builder(
              itemCount: widget.data1!.categoryWithProduct![0].products!.length,
              itemBuilder: (context, index) {
                final data =
                    widget.data1!.categoryWithProduct![0].products![index];
                return Card(
                  elevation: 5,
                              ...
                              child: Image(
                                image: NetworkImage(
                                    "http://gng.invatomarket.com/public/storage/" +
                                        widget.data1!.categoryWithProduct![0]
