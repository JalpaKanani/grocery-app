...
class SweetTamarind extends StatefulWidget {
  static String routeName = '/sweettamarind';

  @override
  _SweetTamarindState createState() => _SweetTamarindState();
}

class _SweetTamarindState extends State<SweetTamarind> {
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: buildText(
                    "Sweet tamarind is a unique tasting fruit that also doubles up either as a spice, or as a tangy-sugary condiment in various Indian dishes, especially on those drool-worthy chaat items, in the form a chutney. Native to South Africa, sweet tamarind grows on the tree that goes with the botanical name Tamarindus indica."),
              ),
              Padding(
