...
class Banana extends StatefulWidget {
  static String routeName = '/banana';
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: buildText(
                    "banana Add to list Share. A banana is a curved, yellow fruit with a thick skin and soft sweet flesh. If you eat a banana every day for breakfast, your roommate might nickname you the monkey. A banana is a tropical fruit that's quite popular all over the world. It grows in bunches on a banana tree."),
              ),
              Padding(
