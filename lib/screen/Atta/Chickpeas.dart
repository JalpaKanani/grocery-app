...
class ChickpeasScreen extends StatefulWidget {
  static String routeName = '/chickpeas';

  @override
  _ChickpeasScreenState createState() => _ChickpeasScreenState();
}

class _ChickpeasScreenState extends State<ChickpeasScreen> {
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: buildText(
                    "The chickpea, Cicer arietinum, is a leguminous annual plant in the family Fabaceae grown for its edible seeds. The plant has a branched, straight or bending stem with small feathery leaves arranged alternately on the stem. The leaves are composed of 11–15 individual leaflets which are oval in shape."),
              ),
              Padding(
