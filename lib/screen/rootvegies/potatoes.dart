...
class Potatoes extends StatefulWidget {
  static String routeName = '/potatoes';

  @override
  _PotatoesState createState() => _PotatoesState();
}
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: buildText(
                    "The sweet potato or sweetpotato (Ipomoea batatas) is a dicotyledonous plant that belongs to the bindweed or morning glory family, Convolvulaceae. Its large, starchy, sweet-tasting (like pumpkin), tuberous roots are used as a root vegetable. The young shoots and leaves are sometimes eaten as greens."),
              ),
              Padding(
