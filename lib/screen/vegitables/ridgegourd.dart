...
class Ridgeground extends StatefulWidget {
  static String routeName = '/ridgeground';
  @override
  _RidgegroundState createState() => _RidgegroundState();
}

class _RidgegroundState extends State<Ridgeground> {
