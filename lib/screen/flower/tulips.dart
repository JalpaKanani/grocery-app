...
class TulipsScreen extends StatefulWidget {
  static String routeName ='tulips';

  @override
  _TulipsScreenState createState() => _TulipsScreenState();
}

class _TulipsScreenState extends State<TulipsScreen> {
