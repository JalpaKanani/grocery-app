...
class Skittles extends StatefulWidget {
  static String routeName = '/skittles';

  @override
  _SkittlesState createState() => _SkittlesState();
}

class _SkittlesState extends State<Skittles> {
