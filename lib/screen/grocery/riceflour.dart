...
class RiceFlour extends StatefulWidget {
  static String routeName = '/riceflour';

  @override
  _RiceFlourState createState() => _RiceFlourState();
}

class _RiceFlourState extends State<RiceFlour> {
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: buildText(
                    "Rice flour (also rice powder) is a form of flour made from finely milled rice. It is distinct from rice starch, which is usually produced by steeping rice in lye. Rice flour is a common substitute for wheat flour."),
              ),
              Padding(
